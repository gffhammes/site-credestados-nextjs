...
const termosDeUso = [
  {
    title: 'DEFINIÇÕES',
    text: `<strong>CRED ESTADOS:</strong> FONTANELLA SERVIÇOS LTDA, sociedade empresarial de responsabilidade limitada, inscrita no CNPJ sob o n°. 37.111.025/0001-72, com sede na cidade de Balneário Camboriú/SC, na Av. Atlântica – no 1530 – Sala 05 - Centro – CEP: 88.330-009.

<strong>CLIENTE:</strong> pessoa física com interesse na contratação de crédito.

<strong>DESTINATÁRIO FINAL:</strong> pessoa física informada pelo CLIENTE como final na cadeia de recebimento dos serviços.

<strong>PARTES:</strong> Cliente e Cred Estados`,
  },
  {
    title: 'ACEITAÇÃO',
    text: `Bem-vindo ao https://www.credestados.com.br/. Este website é controlado e operado pela Cred Estados, empresa localizada na Av Atlântica, 1530 – Sala 05 – Centro – Balneário Camboriú - SC
...
`,
  ...
  {
    title: 'O QUE FAZEMOS?',
    text: `A Cred Estados é uma empresa privada que promove o cadastro de propostas para conectar os CLIENTES com as Instituições Financeiras.`,
  },
  {
    title: 'OBJETO',
    text: `A Cred Estados por meio deste website, proporciona informações gerais sobre a empresa, suas ações e seus produtos. APESAR DOS ESFORÇOS ENVIDADOS PARA MANTER A PRECISÃO E ATUALIZAÇÃO DAS INFORMAÇÕES DISPONIBILIZADAS, A CRED ESTADOS NÃO PODE GARANTIR OU ASSUMIR QUALQUER RESPONSABILIDADE QUANTO A SUA CONFIABILIDADE, EXATIDÃO, VALIDADE, ATUALIDADE, UTILIDADE, INTEGRIDADE, PERTINÊNCIA, OPORTUNIDADE OU ABRANGÊNCIA, NÃO SENDO, PORTANTO, RESPONSÁVEL POR PREJUÍZOS, PERDAS OU DANOS OCORRIDAS PELA VISITA AO SITE. VOCÊ É RESPONSÁVEL POR VERIFICAR A CONFIABILIDADE DAS INFORMAÇÕES ANTES DE TOMAR ALGUMA DECISÃO OU PRATICAR ALGUM ATO.`,
  },
  {
    title: 'ELEGIBILIDADE: DECLARAÇÃO DE MAIORIDADE',
    text: `Como condição para acesso e uso das funcionalidades exclusivas deste website e todos os serviços a ele relacionados, você declara ser maior de 18 (dezoito) anos e, que fez a leitura completa e atenta das regras deste documento, expressando livremente a sua concordância com os termos aqui estipulados.`,
  },
  {
    title: 'UTILIZAÇÃO DO SITE',
    text: `A nossa página está disponível na Internet, por onde você pode acessar seus conteúdos e ver todas as espécies de serviços e produtos ofertados pela empresa. Para tanto, a CRED ESTADOS sempre solicitará a você algumas permissões para o ideal
funcionamento das plataformas durante sua sessão de uso. Em alguns casos, será necessário que você se cadastre.

Desta forma, ao aceitar estes Termos, você reconhece ser o único responsável pelo fornecimento de informações e dados pessoais corretos para o cadastro, eximindo a CRED ESTAODS de toda e qualquer responsabilidade relativa a eventuais informações falsas e/ou inexatas, bem como por eventuais danos e prejuízos decorrentes de tais informações causadas a você, a terceiros ou a própria CRED ESTADOS.
...
Você poderá fazer download, imprimir, ou armazenar informações e materiais disponibilizados neste website para o seu uso particular, exclusivamente, e desde que mantenha intactas todas as notificações de direitos autorais e outras notificações de propriedade. Você não tem permissão para fazer uso das informações, no todo ou em parte, para ganhos comerciais.`,
  },
  {
    ...
    text: `A plataforma pode conter links para sites e aplicações de terceiros. Note que, dentro destes sites e aplicações, você estará sujeito a outros Termos de Uso e a outras Políticas de Privacidade.
...
Nossos Termos não são válidos nos sites e aplicações de terceiros. A existência de links não implica em relação de endosso ou de patrocínio da CRED ESTADOS junto a estes terceiros, e a CRED ESTADOS não tem responsabilidade com relação a estes.`,
  },
  {
    ...
    text: `Para o correto funcionamento deste website se torna indispensável o acesso e tráfego de dados entre terminais de seu computador ou dispositivo móvel e os servidores que hospedam este website. Portanto, a CRED ESTADOS não garante e nem se responsabiliza pela disponibilidade integral e ininterrupta dos serviços aqui disponibilizados, não possuindo, pois, nenhuma ingerência e não sendo responsável por eventuais no acesso a este website.
...
danos ou perdas causados ou sofridos, em razão do uso ou confiança em informações ou materiais obtidos de sites de terceiros.`,
  ...
  {
    title: 'PRIVACIDADE',
    text: `A utilização de alguns serviços oferecidos no website implica a necessidade do fornecimento de dados de caráter pessoal, os quais serão processados nos termos da nossa Política de Privacidade
...
A CRED ESTADOS adota todas as medidas de segurança técnicas e administrativas para a proteção de dados pessoais, nos termos da legislação aplicável e vigente, no que tange à privacidade e proteção de dados pessoais, caso você tenha alguma dúvida, poderá redireciona-la ao nosso comitê de Privacidade através do e-mail:  lgpd@credestados.com.br`,
  ...
  },
  {
    ...
    text: `Os presentes Termos de Uso podem ser atualizados sem prévio aviso ao usuário, sendo mantida neste website sempre a versão mais atualizada e em vigor dos Termos de Uso. Por isto, recomendamos que você consulte a presente Política de Privacidade periodicamente para verificar eventuais alterações.`,
  },
]
