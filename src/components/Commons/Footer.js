        ...
        <div className="container">
          <div className="logo-social">
            ...
            <div className="social-icons">
              <a target='_blank' href={`https://wa.me/55${whatsapp}`} rel="noreferrer"><i className="fab fa-whatsapp"></i></a>
              <a target='_blank' href="https://www.facebook.com/credestados" rel="noreferrer"><i className="fab fa-facebook-f"></i></a>
              <a target='_blank' href="https://www.instagram.com/credestados/" rel="noreferrer"><i className="fab fa-instagram"></i></a>
            </div>
          </div>
          <div className="column navigation">
            ...
            <ul>
              ...
              <li>
                <a target='_blank' href="https://docs.google.com/forms/d/e/1FAIpQLScBeveHxeglbvr38am6FIliXA5IYSQ2Kp4JlXzr6AdWBFrYHw/viewform" rel="noreferrer">
                  Trabalhe conosco
                </a>
              </li>
              <li>
                <a target='_blank' href="https://credestados.stormfin.com.br/" rel="noreferrer">
                  Colaborador
                </a>
              </li>
            </ul>
          ...
          <div className="column icons">
            ...
            <ul>
              <li>
                <a target='_blank' href='mailto:contato@credestados.com.br' rel="noreferrer">
